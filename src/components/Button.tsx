...
const Button: FC<HTMLMotionProps<'button'>> = ({
  ...
  return (
    <motion.button
      className={cn(
        'relative rounded-full cursor-pointer w-fit flex items-center justify-center gap-3 text-center text-base px-[22px] py-3 text-nowrap select-none transition',
